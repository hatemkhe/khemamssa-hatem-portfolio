...
const t = {
  ...
  drawInTitle: "Draw In",
  drawInDesc: "An intuitive web-based drawing and digital canvas application built for creative sketching, canvas manipulation, and artwork export.",
  switchFilesTitle: "Switch Files Type",
  switchFilesDesc: "A versatile online file converter and format switching tool designed for quick, secure, and seamless file type conversions.",
    ...
    >
      ...
      <section id="hero" className="relative pt-12 pb-24 md:pt-20 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center">
        <div className="text-center max-w-3xl">
          ...
          {/* Subheading bio */}
          <div className="text-lg sm:text-xl text-slate-300 leading-relaxed mb-10 max-w-2xl mx-auto space-y-3">
            <p className="text-slate-200 font-semibold text-xl sm:text-2xl">
              Programmer, game developer, and cybersecurity trainer
            </p>
            <div className="pt-2 text-base sm:text-lg text-slate-400">
              <p className="text-slate-400 text-xs sm:text-sm uppercase tracking-wider font-mono mb-2">With good experience in:</p>
              <p className="font-bold text-blue-400 tracking-wide text-lg sm:text-xl mb-1">Godot — Unity</p>
              <p className="font-mono font-semibold text-emerald-400 text-base sm:text-lg">C++ — Python — GDScript</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">Canvas API</span>
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">Web App</span>
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">Digital Art</span>
                  </div>
                </div>

                <div className="mt-auto">
                  <a 
                    href="https://drawkhe.netlify.app/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="btn-primary w-full py-3 px-4 rounded-xl text-xs font-bold text-center inline-flex items-center justify-center gap-2 card-hover"
                  >
              ...
              {/* MC Commands - Live Project in 2026 */}
              <div 
                id="project-mc-commands"
                className="glass p-6 rounded-2xl flex flex-col justify-between card-hover border-purple-500/30 overflow-hidden relative"
              >
                {/* Decorative element */}
                <div className="absolute top-0 right-0 left-0 h-[3px] bg-purple-500" />
                
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="px-2.5 py-1 text-[10px] uppercase font-bold tracking-wider rounded-md bg-purple-950/40 text-purple-400 border border-purple-900/30">
                      {t.liveProjectBadge}
                    </span>
                    <span className="text-xs text-slate-500 font-mono">2026</span>
                  </div>

                  <h4 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors duration-200 mb-3">
                    {t.mcCommandsTitle}
                  </h4>
                  <p className="text-slate-400 text-sm leading-relaxed mb-6">
                    {t.mcCommandsDesc}
              ...
              {/* Switch Files Type - Live Project in 2026 */}
              <div 
                id="project-switch-files"
                className="glass p-6 rounded-2xl flex flex-col justify-between card-hover border-amber-500/30 overflow-hidden relative"
              >
                {/* Decorative element */}
                <div className="absolute top-0 right-0 left-0 h-[3px] bg-amber-500" />
                
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="px-2.5 py-1 text-[10px] uppercase font-bold tracking-wider rounded-md bg-amber-950/40 text-amber-400 border border-amber-900/30">
                      {t.liveProjectBadge}
                    </span>
                    <span className="text-xs text-slate-500 font-mono">2026</span>
                  </div>

                  <h4 className="text-xl font-bold text-white group-hover:text-amber-400 transition-colors duration-200 mb-3">
                    {t.switchFilesTitle}
                  </h4>
                  <p className="text-slate-400 text-sm leading-relaxed mb-6">
                    {t.switchFilesDesc}
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">Converter</span>
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">File Utility</span>
                    <span className="text-[11px] font-mono bg-slate-900/60 border border-white/5 text-slate-300 px-2.5 py-1 rounded">Web App</span>
                  </div>
                </div>
                ...
                <div className="mt-auto">
                  <a 
                    href="https://hswitchfiles.netlify.app/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="btn-primary w-full py-3 px-4 rounded-xl text-xs font-bold text-center inline-flex items-center justify-center gap-2 card-hover"
                  >
